...
export const LightTokensDefault = {
  ...
  primaryFixed: "#FFDAD9",
  onPrimaryFixed: "#400009",
  primaryFixedDim: "#FFB3B3",
  onPrimaryFixedVariant: "#82252D",
  secondaryFixed: "#FFDAD9",
  onSecondaryFixed: "#2C1515",
  secondaryFixedDim: "#E6BDBC",
  onSecondaryFixedVariant: "#5D3F3F",
  tertiaryFixed: "#FFDDAF",
  onTertiaryFixed: "#281800",
  tertiaryFixedDim: "#E5C18D",
  onTertiaryFixedVariant: "#5B421A",
  surface: "#FFF8F7",
  onSurface: "#201A1A",
  surfaceBright: "#FFF8F7",
  surfaceDim: "#E4D7D6",
  surfaceContainerHighest: "#ECE0DF",
  surfaceContainerHigh: "#F2E5E4",
  surfaceContainer: "#F8EBEA",
  surfaceContainerLow: "#FEF1F0",
...
export const DarkTokensDefault = {
  ...
  inversePrimary: "#A13D43",
  inverseOnPrimary: "",
  shadow: "#000000",
  scrim: "#000000",
  surfaceTintColor: "#FFB3B3",
  background: "#201A1A",
  onBackground: "#ECE0DF",
